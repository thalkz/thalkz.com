...
- Written in February 2026
    ...
    "We are part of the last generation of software developers. The job will survive. We still need people that are responsible for the tech, maintaining the product & making it evolve. However, it will take a completely different shape. Especially, all the knowledge around the craft of writing code will disappear."
...
In the _new world_ writing code is alsmost free and fast. Reading code directly makes very little sense: an AI can do it better and will have fewer blind spots. Writing code that is optimized for humans doesn't make much sense anymore: we won't read it, an AI will.
...
_It is just not required anymore._ 